 ...
 * @Description:
 */
@Component("拨打网点电话个数判断上一级")
public class CheckPhoneNumberA implements DecisionHandler {
    @Autowired
    ...
    public String handle(Context context, ProcessInstance processInstance) {
        ...
        Long company_parentid = company.getCompany_parentid();
        Company company1 = companyService.get(company_parentid);
        String t1 = company1.getCompany_tel();
        String t2 = company1.getCompany_tel_2();
        String t3 = company1.getCompany_tel_3();
        int num = 0;
