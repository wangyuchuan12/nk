...
@Component("破损网点电话结果判断")
public class BrokenNetRA implements DecisionHandler{

    private static org.slf4j.Logger logger = LoggerFactory.getLogger(BrokenNetRA.class);
