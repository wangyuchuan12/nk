package com.ifrabbit.nk.flow.process.decision.express.reminder.decision;
 ...
 * Time:16:10
 */
@Component("催单-物流结果判断是否签收")
public class ExpressResultReminder implements DecisionHandler {
    @Autowired
