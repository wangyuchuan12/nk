 ...
 * @Description:
 */
@Component("拨打网点电话个数判断上三级")
public class CheckPhoneNumberC implements DecisionHandler {
    @Autowired
    ...
    public String handle(Context context, ProcessInstance processInstance) {
        ...
        Company company3 = companyService.get(company2.getCompany_parentid());
        String t1 = company3.getCompany_tel();
        String t2 = company3.getCompany_tel_2();
        String t3 = company3.getCompany_tel_3();
        int num = 0;
