...
CREATE TABLE `tbase_sysrltn` (
  ...
  `sysrltn_mainid` bigint(20) DEFAULT NULL COMMENT '主数据',     --sys关联角色
  `sysrltn_assistid` bigint(20) DEFAULT NULL COMMENT '关联数据', --sys关联人员
...
CREATE TABLE `tapp_problemparts` (
  ...
  `problemparts_staffid` bigint(12) DEFAULT NULL COMMENT '表单id',
...
----初始信息表--chen
CREATE TABLE `TManage_OriginalDate` (
  `ODate_ID` bigint(20) NOT NULL COMMENT 'ID',
  `ODate_CompanyID` bigint(20) DEFAULT NULL COMMENT '网点ID',
  `ODate_CompanyCode` varchar(100) DEFAULT NULL COMMENT '网点编码',
  `ODate_UserID` bigint(20) DEFAULT NULL COMMENT '用户ID',
  `ODate_UserName` varchar(64) DEFAULT NULL COMMENT '用户姓名（客服姓名）',
  `ODate_UserType` smallint(6) DEFAULT NULL COMMENT '用户类型',
  `ODate_ProblemType` smallint(6) DEFAULT NULL COMMENT '问题类型',
  `ODate_OriginalAmount` decimal(12,2) NOT NULL COMMENT '初始值（统计初始值）',
  `ODate_Originalown` float DEFAULT NULL COMMENT '应收总金额（金额的初始值）',
  `ODate_OriginalSum` float DEFAULT NULL COMMENT '已收款总金额（金额的初始值）',
  `ODate_OriginalDate` date NOT NULL COMMENT '初始数据时间（统计初始值的时间，该时间就是统计计算的起点时间）',
  `ODate_DateType` smallint(6) DEFAULT NULL COMMENT '统计数据类型（用整型值代表统计类型，例如1=阶段日结，2=日结，3=周结，4=月结等）',
  `ODate_Responsor` varchar(100) DEFAULT NULL COMMENT '设置人（统计数据初始值设置人（当由计算机自动设置初始值时，设置人为空值））',
  `ODate_SetTime` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '设置时间',
  `ODate_State` smallint(6) DEFAULT NULL COMMENT '数据状态',
  `ODate_Memo` varchar(100) DEFAULT NULL COMMENT '备注',
  `ODate_VarParamA` varchar(1024) DEFAULT NULL COMMENT '字符备用字段',
  `ODate_VarParamB` varchar(1024) DEFAULT NULL COMMENT '字符备用字段',
  `ODate_VarParamC` varchar(1024) DEFAULT NULL COMMENT '字符备用字段',
  `ODate_VarParamD` varchar(1024) DEFAULT NULL COMMENT '字符备用字段',
  `ODate_VarParamE` varchar(1024) DEFAULT NULL COMMENT '字符备用字段',
  `ODate_IntParamA` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `ODate_IntParamB` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `ODate_IntParamC` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `ODate_IntParamD` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `ODate_IntParamE` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `ODate_FloatParamA` float DEFAULT NULL COMMENT '浮点备用字段',
  `ODate_FloatParamB` float DEFAULT NULL COMMENT '浮点备用字段',
  `ODate_FloatParamC` float DEFAULT NULL COMMENT '浮点备用字段',
  `ODate_FloatParamD` float DEFAULT NULL COMMENT '浮点备用字段',
  `ODate_FloatParamE` float DEFAULT NULL COMMENT '浮点备用字段',
  PRIMARY KEY (`ODate_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

----结存信息表--chen
CREATE TABLE `TManage_Account` (
  `Account_ID` bigint(20) NOT NULL COMMENT 'ID',
  `Account_CompanyID` bigint(20) DEFAULT NULL COMMENT '网点ID',
  `Account_CompanyName` varchar(64) DEFAULT NULL COMMENT '网点名称',
  `Account_CompanyCode` varchar(32) DEFAULT NULL COMMENT '网点编码',
  `Account_UserName` varchar(50) DEFAULT NULL COMMENT '客服姓名',
  `Account_UserID` bigint(20) DEFAULT NULL COMMENT '客服ID',
  `Account_Amount` bigint(20) DEFAULT NULL COMMENT '结存数量',
  `Account_Sum` decimal(12,2) DEFAULT NULL COMMENT '结存金额',
  `Account_ProblemType` smallint(6) DEFAULT NULL COMMENT '问题类型',
  `Account_Type` smallint(6) NOT NULL COMMENT '结存类别（用整型值代表统计类型，例如1=阶段日结，2=日结，3=周结，4=月结等）',
  `Account_Period` smallint(6) DEFAULT NULL COMMENT '结存周期标志（在结存类别之上增加的标志，表明结存区间。比如阶段日结，午夜零点到一点期间的结存周期标志为1.）',
  `Account_Date` date NOT NULL COMMENT '更新时间（数据记录的日期。如果数据记录时间超过午夜12点，则数据记录日期应该自动减一天）',
  `Account_Time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '记录时间（数据记录的时间）',
  `Account_Memo` varchar(1024) DEFAULT NULL COMMENT '备注',
  `ExmPart_VarParamA` varchar(1024) DEFAULT NULL COMMENT '字符备用字段',
  `ExmPart_VarParamB` varchar(1024) DEFAULT NULL COMMENT '字符备用字段',
  `ExmPart_VarParamC` varchar(1024) DEFAULT NULL COMMENT '字符备用字段',
  `ExmPart_VarParamD` varchar(1024) DEFAULT NULL COMMENT '字符备用字段',
  `ExmPart_VarParamE` varchar(1024) DEFAULT NULL COMMENT '字符备用字段',
  `ExmPart_IntParamA` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `ExmPart_IntParamB` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `ExmPart_IntParamC` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `ExmPart_IntParamD` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `ExmPart_IntParamE` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `ExmPart_FloatParamA` float DEFAULT NULL COMMENT '浮点备用字段',
  `ExmPart_FloatParamB` float DEFAULT NULL COMMENT '浮点备用字段',
  `ExmPart_FloatParamC` float DEFAULT NULL COMMENT '浮点备用字段',
  `ExmPart_FloatParamD` float DEFAULT NULL COMMENT '浮点备用字段',
  `ExmPart_FloatParamE` float DEFAULT NULL COMMENT '浮点备用字段',
  PRIMARY KEY (`Account_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

----当前统计信息表--chen
CREATE TABLE `TManage_Data` (
  `MData_ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `MData_CompanyID` bigint(20) DEFAULT NULL COMMENT '网点ID',
  `MData_CompanyName` varchar(64) DEFAULT NULL COMMENT '网点名称',
  `MData_CompanyCode` varchar(32) DEFAULT NULL COMMENT '网点编码',
  `MData_UserName` varchar(50) DEFAULT NULL COMMENT '客户姓名',
  `MData_UserID` bigint(20) DEFAULT NULL COMMENT '客服ID',
  `MData_UserType` bigint(20) DEFAULT NULL COMMENT '用户类型',
  `MData_ProblemType` smallint(6) DEFAULT NULL COMMENT '问题类别',
  `MData_Amount` decimal(12,2) DEFAULT NULL COMMENT '结存数量',
  `MData_Own` decimal(12,2) DEFAULT NULL COMMENT '应收款金额',
  `MData_Sum` decimal(12,2) DEFAULT NULL COMMENT '收款金额',
  `MData_Type` smallint(6) NOT NULL COMMENT '结存类别 用整型值代表统计类型，例如1=阶段日结，2=日结，3=周结，4=月结等',
  `MData_Period` smallint(6) DEFAULT NULL COMMENT '结存周期标志 在结存类别之上增加的标志，表明结存区间。比如阶段日结，午夜零点到一点期间的结存周期标志为1',
  ...
  `MData_State` smallint(6) NOT NULL COMMENT '状态',
  `MData_Memo` varchar(255) NOT NULL COMMENT '更新时间',
  `MData_VarParamA` varchar(255) DEFAULT NULL COMMENT '字符备用字段',
  `MData_VarParamB` varchar(255) DEFAULT NULL COMMENT '字符备用字段',
  `MData_VarParamC` varchar(255) DEFAULT NULL COMMENT '字符备用字段',
  `MData_VarParamD` varchar(255) DEFAULT NULL COMMENT '字符备用字段',
  `MData_VarParamE` varchar(255) DEFAULT NULL COMMENT '字符备用字段',
  `MData_IntParamA` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `MData_IntParamB` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `MData_IntParamC` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `MData_IntParamD` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `MData_IntParamE` bigint(20) DEFAULT NULL COMMENT '数字备用字段',
  `MData_FloatParamA` float DEFAULT NULL COMMENT '浮点备用字段',
  `MData_FloatParamB` float DEFAULT NULL COMMENT '浮点备用字段',
  `MData_FloatParamC` float DEFAULT NULL COMMENT '浮点备用字段',
  `MData_FloatParamD` float DEFAULT NULL COMMENT '浮点备用字段',
  `MData_FloatParamE` float DEFAULT NULL COMMENT '浮点备用字段',
  PRIMARY KEY (`MData_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=90331 DEFAULT CHARSET=utf8;
